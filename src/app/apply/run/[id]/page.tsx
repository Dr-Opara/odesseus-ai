...
function statusCopy(status: string) {
  switch (status) {
    ...
    case "running":
      return "Odesseus is completing the application.";
    case "needs_user":
      return "Odesseus needs you for a moment.";
          ...
          <div className="card human-step-card">
            <div>
              ...
              <p className="muted" style={{ margin: 0, lineHeight: 1.55 }}>
                Complete login, MFA, CAPTCHA, identity confirmation, or any other step Odesseus intentionally leaves to you. Then return here and continue.
              </p>
            </div>
            <a
              className="btn btn-secondary"
        ...
        <section style={{ marginTop: 28 }}>
          ...
          <div className="card apply-timeline">
            {events?.length ? events.map((event, index) => (
              ...
              <div className="muted" style={{ padding: 22 }}>Odesseus is preparing the application.</div>
            )}
          </div>
        </section>
