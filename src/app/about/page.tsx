...
const faqs=[
 ["Does Odesseus require a subscription?","No. Candidate application and Live products can be purchased separately."],
 ...
 ["Where can I use Odesseus Live?","Odesseus Live is designed for desktop/web."],
