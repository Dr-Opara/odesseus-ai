...
export const metadata: Metadata = {
  title: "Pricing — Odesseus",
  description: "No subscription. Pay when Odesseus works for you. $0.99 per successful application, $24.99 per live interview, with savings bundles available.",
};
  ...
  return (
    <main className="marketing">
      ...
      <section className="shell page-hero" style={{ textAlign: "center", maxWidth: 700, margin: "0 auto" }}>
        <h1 className="font-display page-hero-headline">No subscription. Pay when Odesseus works for you.</h1>
      </section>
      ...
      <section className="shell" style={{ padding: "10px 0 20px" }}>
        ...
        <div className="pricing-full-grid">
          <div className="card pricing-full-card">
            ...
            <h2 style={{ fontSize: 24, margin: "10px 0 6px" }}>Apply with Odesseus</h2>
          ...
          <div className="card pricing-full-card">
            ...
            <h2 style={{ fontSize: 24, margin: "10px 0 6px" }}>Odesseus Live</h2>
      ...
      <section className="shell pricing-section">
        ...
        <div className="card bundle-band">
          ...
          <p className="bundle-fine-print">
            Same billing guarantees as pay-as-you-go: a successful submission consumes 1 credit. Failed, unsupported, cancelled, and closed-role applications, and submissions that cannot be confirmed, consume 0. Credits only change the price — every credit includes the full Apply with Odesseus workflow.
          </p>
        </div>
      </section>
      ...
      <section className="shell pricing-section">
        <div className="pricing-section-heading">
          ...
          <p className="pricing-section-note">1 interview pass = 1 successfully activated Odesseus Live interview round.</p>
        </div>

        <div className="card bundle-band">
          <div className="bundle-row bundle-row-2">
            <div className="bundle-option">
              <div className="bundle-option-quantity">3 Odesseus Live Passes</div>
          ...
          <p className="pricing-flow-chain" style={{ marginTop: 18 }}>
            Odesseus Live Annual: Prepare → Live Guidance → Transcript → Analysis → Follow-Up
          </p>
          <p className="bundle-fine-print">
            Unlimited Odesseus Live interviews for 12 months, subject to fair use. A failed Live activation never consumes a pass or counts against the annual plan.
          </p>
        </div>
      </section>
      ...
      <section className="shell pricing-section" style={{ paddingBottom: 20 }}>
        <div className="pricing-section-heading">
          ...
          <h2 className="pricing-section-title">Free with Odesseus</h2>
        ...
        <div className="page-cta-band card">
          <div>
            ...
            <p className="muted" style={{ margin: 0 }}>No subscription. Pay only when Odesseus works for you.</p>
          </div>
