...
export const metadata = { title: "Partner Program Terms — Odysseus" };
  ...
  return (
    <main className="marketing-page">
      ...
      <section className="shell partner-terms">
        ...
        <h1>Clear expectations for Odysseus partners.</h1>
        ...
        {[
          ["Truthful marketing","Partners must accurately describe Odysseus and may not promise jobs, interviews, income, or hiring outcomes."],
          ...
          ["Brand usage","Odysseus names, logos, screenshots, and campaign assets may be used only for approved program activity and may not imply ownership, endorsement, or employment."],
          ...
          ["Termination","Odysseus may suspend or end participation for policy violations, fraud, brand misuse, or other material breaches of program terms."],
        ].map(([title,body]) => (
